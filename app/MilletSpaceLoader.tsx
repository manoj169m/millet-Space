...
const MilletSpaceLoader = () => {
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-green-50 w-full">
      <div className="flex flex-col items-center">
        <div className="relative w-32 h-32">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            {[...Array(8)].map((_, i) => (
              <div
                key={i}
                className="absolute w-2 h-4 rounded-full bg-green-500"
                style={{
        ...
        <div className="mt-6 text-center">
          <div className="text-2xl text-green-800 font-bold tracking-wider">Millet Space</div>
          <div className="text-sm text-green-600 mt-1">Organic Goodness Loading...</div>
        </div>
      </div>
    </div>
  );
