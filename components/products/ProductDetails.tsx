...
export default function ProductDetails({ product }: ProductDetailsProps) {
  ...
  const { user, isLoaded } = useUser(); // Ensure you are checking the loading state of the user
  ...
  // Fetch comments for the product only after user is loaded
  useEffect(() => {
    ...
    if (isLoaded) { // Ensure the user is loaded before fetching comments
      fetchComments();
    }
  }, [product.id, isLoaded]); // Add isLoaded as a dependency to ensure it runs after user is loaded
